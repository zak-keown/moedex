...
#[derive(Debug, Parser)]
#[command(bin_name = "moedex plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin add",
    after_help = "Examples:\n  moedex plugin add sample@debug\n  moedex plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin list",
    after_help = "Examples:\n  moedex plugin list\n  moedex plugin list --marketplace debug\n  moedex plugin list --json\n  moedex plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin remove",
    after_help = "Examples:\n  moedex plugin remove sample@debug\n  moedex plugin remove sample --marketplace debug"
)]
