...
#[derive(Debug, Parser)]
#[command(bin_name = "moedex plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Moedex is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin marketplace add",
    after_help = "Examples:\n  moedex plugin marketplace add ./path/to/marketplace\n  moedex plugin marketplace add owner/repo --ref main\n  moedex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "moedex plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin marketplace upgrade",
    after_help = "Examples:\n  moedex plugin marketplace upgrade\n  moedex plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "moedex plugin marketplace remove",
    after_help = "Example:\n  moedex plugin marketplace remove debug"
)]
