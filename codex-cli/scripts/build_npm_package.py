#!/usr/bin/env python3
"""Stage and optionally package the fork-owned Moedex npm module."""
...
CODEX_NPM_NAME = "@zak-keown/moedex"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package is fork-owned; publication remains disabled by default.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@zak-keown/moedex-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@zak-keown/moedex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@zak-keown/moedex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@zak-keown/moedex-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@zak-keown/moedex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@zak-keown/moedex-win32-arm64",
        "npm_tag": "win32-arm64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build or stage the Moedex CLI npm package."
    )
    parser.add_argument(
        "--package",
