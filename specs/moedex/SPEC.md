...
| [MAINTENANCE.md](MAINTENANCE.md) | Six-priority maintenance supplement: release ownership, portable CI, verification policy, advisory lint, required remote telemetry removal, and community automation. Adds no completed implementation stages. |
